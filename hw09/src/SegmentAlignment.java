...
//        String x = "occurrence";
    ...
    private static void align(String sentence1, String sentence2, int xStart, int yStart) {
        ...
        int[] YPrefix = AllYPrefixCosts(sentence1, n / 2, sentence2, xStart, yStart);
        int[] YSuffix = AllSuffixCosts(sentence1, n / 2, sentence2, xStart, yStart);
    ...
    private static int[] AllSuffixCosts(String sentence1, int mid, String sentence2, int xStart, int yStart) {
        String newSentence = "";
    ...
    private static int[] AllYPrefixCosts(String sentence1, int mid, String sentence2, int xStart, int yStart) {
